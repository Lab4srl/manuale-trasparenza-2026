...
Le amministrazioni possono pubblicare dati, informazioni e documenti ulteriori rispetto a quelli oggetto di obbligo, ma in questo caso devono farlo nel rispetto dell’art. 7-bis, comma 3, del D.lgs. n. 33/2013. Se nei dati ulteriori sono presenti dati personali, questi devono essere pubblicati in forma anonima.
...
I dati particolari e i dati giudiziari, invece, sono sottratti all’indicizzazione. Per tali informazioni l’amministrazione deve adottare cautele tecniche e organizzative coerenti con la natura dei dati trattati, verificando anche le impostazioni della piattaforma utilizzata per la pubblicazione.

## Indicazioni operative per gli uffici

Per ridurre il rischio di pubblicazioni non corrette, è opportuno che ogni ufficio applichi una procedura minima di controllo prima dell’invio o del caricamento dei documenti:

1. individuare l’obbligo di pubblicazione e la relativa base normativa;
2. confrontare il contenuto del documento con le sole informazioni richieste dall’obbligo;
3. rimuovere o oscurare i dati personali non pertinenti;
4. verificare con particolare attenzione la presenza di dati particolari o giudiziari;
5. controllare che l’oscuramento sia tecnicamente irreversibile;
6. pubblicare, quando possibile, dati in forma tabellare, sintetica o aggregata;
7. programmare il controllo periodico di esattezza, aggiornamento e durata della pubblicazione.
