...
4. "**IBAN e pagamenti informatici**": devono essere pubblicate le informazioni relative alle modalità di pagamento accettate dall'ente, ai sensi dell'art. 36 del D.lgs. n. 33/2013, secondo le indicazioni della deliberazione ANAC n. 77 del 16 febbraio 2022.
   ...
   |---|---|
   | **Ambito temporale di riferimento - anno** | Anno di riferimento del pagamento, in formato numerico a quattro cifre |
   | **Ambito temporale di riferimento - trimestre** | Trimestre di riferimento, con valore 1, 2, 3 o 4 |
   | **Categoria di spesa** | Valore vincolato tra "uscite correnti" e "uscite in conto capitale" |
   | **Tipologia di spesa** | Valore vincolato coerente con la categoria di spesa |
   | **Importo** | Importo del singolo pagamento per ciascun beneficiario nel trimestre di riferimento |
   | **Beneficiario** | Valore vincolato tra "Persona fisica", "Altro soggetto pubblico e privato" e "Soggetto estero" |

   Le **tipologie di spesa** previste dallo schema sono:

   | Categoria | Tipologie ammesse |
   |---|---|
...
* per la produzione del prospetto sui dati dei pagamenti, lo schema ANAC di cui alla deliberazione n. 495/2024, come modificata dalla deliberazione n. 481/2025, prevede il raccordo con il **Piano dei conti finanziario** di cui all'Allegato 6.1 del D.lgs. n. 118/2011; in particolare:

  | Tipologia dello schema ANAC | Voce del Piano dei conti finanziario |
  |---|---|
  | Acquisto di beni e di servizi | U.1.03.00.00.000 |
  | Contributi in conto esercizio | U.1.04.00.00.000 |
  | Interessi passivi | U.1.07.00.00.000 |
  | Altre spese per attività finanziarie | U.1.08.00.00.000 |
  | Altre spese correnti | U.1.10.00.00.000 |
  | Investimenti in beni materiali | U.2.02.01.00.000; U.2.02.02.00.000; U.2.02.04.00.000; U.2.02.05.00.000 |
  | Investimenti in beni immateriali | U.2.02.03.00.000; U.2.02.06.00.000 |
  | Investimenti in attività finanziarie | U.3.01.00.00.000 |
  | Contributi in conto capitale | U.2.03.00.00.000 |
  | Altre spese in conto capitale | U.2.05.00.00.000 |
...
* a seguito dell'art. 8, comma 2, del D.L. n. 19/2026, convertito con modificazioni dalla L. n. 50/2026, i soggetti di cui all'art. 2-bis del D.lgs. n. 33/2013 i cui dati sui pagamenti sono già inseriti nella banca dati che alimenta il sito "**Soldi pubblici**" assolvono agli obblighi di pubblicazione di cui all'art. 4-bis pubblicando, nella sezione "**Amministrazione trasparente**" del proprio sito istituzionale, il collegamento al predetto sito
